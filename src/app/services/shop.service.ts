...
export class ShopService {
  ...
  private fallbackDatabase: Record<string, Omit<Item, 'id'>> = {
    'heavy-ball': { name: 'Heavy Ball', price: 1000, type: 'Ball', image: '🔮' },
    'love-ball': { name: 'Love Ball', price: 1000, type: 'Ball', image: '💝' },
    'quick-ball': { name: 'Quick Ball', price: 1000, type: 'Ball', image: '⚡' },
    'luxury-ball': { name: 'Luxury Ball', price: 3000, type: 'Ball', image: '👑' },
    'dusk-ball': { name: 'Dusk Ball', price: 1000, type: 'Ball', image: '🟢' },
    'max-potion': { name: 'Max Potion', price: 2500, type: 'Medicine', image: '🧪' },
    'full-restore': { name: 'Full Restore', price: 3000, type: 'Medicine', image: '💉' },
    'max-revive': { name: 'Max Revive', price: 4000, type: 'Medicine', image: '✨' },
    'full-heal': { name: 'Full Heal', price: 600, type: 'Medicine', image: '💚' },
    'oran-berry': { name: 'Oran Berry', price: 100, type: 'Berry', image: '🍓' },
    'pecha-berry': { name: 'Pecha Berry', price: 100, type: 'Berry', image: '🍑' },
    'sitrus-berry': { name: 'Sitrus Berry', price: 400, type: 'Berry', image: '🍋' },
    'thunder-stone': { name: 'Thunder Stone', price: 3000, type: 'Hold Item', image: '💎' },
    'fire-stone': { name: 'Fire Stone', price: 3000, type: 'Hold Item', image: '🔥' },
    'water-stone': { name: 'Water Stone', price: 3000, type: 'Hold Item', image: '💧' },
    'zinc': { name: 'Zinc', price: 9800, type: 'Tool', image: '📦' },
    'protein': { name: 'Protein', price: 9800, type: 'Tool', image: '💪' },
    'iron': { name: 'Iron', price: 9800, type: 'Tool', image: '🛡️' },
    'carbos': { name: 'Carbos', price: 9800, type: 'Tool', image: '👟' }
  };
  ...
  async fetchItemFromPokeAPI(queryName: string): Promise<void> {
    ...
    try {
      ...
      if (cleanQuery.includes('ball')) {
        visualEmoji = '🔮';
      } else if (cleanQuery.includes('berry')) {
        visualEmoji = '🍓';
      } else if (cleanQuery.includes('stone')) {
        visualEmoji = '💎';
      }
      ...
      const newItem: Item = {
        id: Date.now(),
        name:
          data.names.find((name: any) => name.language.name === 'en')?.name ??
          data.name.replace(/-/g, ' '),
